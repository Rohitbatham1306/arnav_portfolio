...
function TimelineRow({
  ...
  return (
    <motion.div
      ...
      className="flex justify-start pt-10 md:pt-40 md:gap-10 overflow-hidden"
    >
      <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
        <div className="h-10 absolute left-1 sm:left-3 md:left-3 w-10 rounded-full bg-white dark:bg-black flex items-center justify-center">
