            ...
            >
              ...
              <div className="flex flex-col md:flex-row flex-1 gap-8 md:gap-0">
                ...
                <motion.div
                  ...
                  className="hidden md:flex flex-col justify-between w-72 lg:w-[26rem] pl-8 lg:pl-12 border-l border-border/20 py-2"
                >
                  {/* CTA section */}
                  ...
                  <div className="flex flex-col gap-2.5">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {[
                        ...
                        <span
                          key={service}
                          className="px-2.5 py-1 text-[11px] font-mono tracking-wide rounded-md bg-foreground/5 border border-border/40 text-foreground/80"
                        >
                          {service}
                        </span>
                      ))}
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-1.5">
                      {socialLinks.map((social, i) => (
                        <motion.a
                          ...
                          className="group/social relative text-xs md:text-sm text-muted-foreground hover:text-foreground transition-colors"
                        >
                          {social.name}
                          <motion.span
