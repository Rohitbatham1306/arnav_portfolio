  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center scroll-smooth">
      ...
      <section id="contact" className="w-full scroll-mt-24 py-16 md:py-24 flex flex-col items-center justify-center gap-6 px-4">
        ...
        <h3 className="text-3xl sm:text-4xl md:text-6xl font-bold tracking-tight text-center px-2">
        ...
        <a
          ...
          className="inline-flex items-center gap-2.5 sm:gap-3 px-5 sm:px-7 py-3.5 sm:py-4 rounded-full bg-green-500 hover:bg-green-400 text-white font-semibold text-base sm:text-lg transition-all duration-200 shadow-lg hover:shadow-green-500/30 hover:scale-105"
        >
          ...
          <span>WhatsApp: +91 877 079 4033</span>
        </a>
        <a
